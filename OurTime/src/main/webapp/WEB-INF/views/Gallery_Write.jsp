...
<html>
  <head>
    ...
    <script src="resources/js/Gallery_Write.js"></script>
...
<div class="container" >
  <main>
    <div class="py-5 text-center">
      ...
      <h2>글 쓰기</h2>
      <p class="lead">회원님의 아름다운 사진을 업로드해주세요</p>
    </div>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <h4 class="mb-3"></h4>
            ...
            <div class="col-12">
              ...
              <div class="input-group">
                <input type="text" class="form-control" id="email" name="email" value="${MyProfile.email}" readonly="readonly">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="file" class="form-control" id="upload" name="uploadFile" placeholder="ex)1234">
              <div class="invalid-feedback">
                  	사진을 업로드 해주세요
              </div>
            </div>
      ...
      <div class="loadsult">
		<ul>
          ...
          <hr class="my-4">
           ...
           <input class="w-50 btn btn-primary btn-lg" type="submit" value="등록" style="float: left; border: 0;"  onclick="btn_click('write')">
